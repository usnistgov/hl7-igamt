...
import gov.nist.hit.hl7.igamt.shared.domain.exception.UploadImageFileException;
...
public class FileStorageController {
	...
	@RequestMapping(value = FileStorageUtil.UPLOAD_URL, method = RequestMethod.POST,consumes = MediaType.MULTIPART_FORM_DATA_VALUE, produces = "application/json")
