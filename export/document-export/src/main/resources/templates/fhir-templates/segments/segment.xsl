...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <xsl:template name="segmentF">
        ...
        <xsl:call-template name="sub-headbar">
            ...
            <xsl:with-param name="sub-header3" select="concat($segment/@label, ' - ', $segment/@description)"/>
            <xsl:with-param name="sub-path3" select="concat('#segment-', $segment/@id)"/>
        </xsl:call-template>
        ...
        <div>
            <p align="center">
                <xsl:value-of select="concat('HL7 Attribute Table - ', $segment/@label, ' - ', $segment/@description)" />
            </p>
            <table class="element-table">
                <tr class="element-header">
                    <th class="element-header-column">
                        <a href="#segments">Seq#</a>
                    </th>
                    <th class="element-header-column">
                        <a href="#segments">Description</a>
                    </th>
                    <th class="element-header-column">
                        <a href="#segments">Data Type</a>
                    </th>
                    <th class="element-header-column">
                        <a href="#segments">Usage</a>
                    </th>
                    <th class="element-header-column">
                        <a href="#segments">Value Set</a>
                    </th>
                    <th class="element-header-column">
                        <a href="#segments">Cardinality</a>
                    </th>
                    <th class="element-header-column">
                        <a href="#segments">Length</a>
                    </th>
                    <th class="element-header-column">
                        <a href="#segments">Conf. Length</a>
                    </th>
                </tr>
                <tr>
                    <td colspan="3">
                ...
                <xsl:for-each select="$segment/Fields/Field">
