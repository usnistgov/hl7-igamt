...
public class ValidationServiceImpl implements VerificationService {
  ...
  private void checkingStructureForDatatype(Datatype datatype, VerificationResult vr) {
    ...
    if (datatype instanceof PrimitiveDatatype) {
      PrimitiveDatatype pDt = (PrimitiveDatatype)datatype;
      //NO Checking
    }
    ...
    if (datatype instanceof ComplexDatatype) {
      ...
      this.checkingComponents(datatype, cDt.getComponents(), vr);
  ...
  private void checkingComponent(ComplexDatatype cDt, Component c, VerificationResult vr) {
    ...
    if(this.isLengthAllowedComponent(c)) {
      if((confLength == null || confLength.equals("NA")) && ((maxLength == null || maxLength.equals("NA")) || (minLength == null || minLength.equals("NA")))) vr.addDatatypeError(new DatatypeObjectError(cDt.getId(), "STRUCTURE", "component.length", "Component length should be required.", position + "", "HIGH"));
      if((confLength != null && !confLength.equals("NA")) && ((minLength != null && !minLength.equals("NA")) || (maxLength != null && !maxLength.equals("NA")))) vr.addDatatypeError(new DatatypeObjectError(cDt.getId(), "STRUCTURE", "component.length", "Component length should defined using a single way.", position + "", "HIGH"));
      if((maxLength == null || maxLength.equals("NA")) && (minLength != null && !minLength.equals("NA"))) vr.addDatatypeError(new DatatypeObjectError(cDt.getId(), "STRUCTURE", "component.maxLength", "Component maxLength is not defined.", position + "", "HIGH"));
      if((maxLength != null && !maxLength.equals("NA")) && (minLength == null || minLength.equals("NA"))) vr.addDatatypeError(new DatatypeObjectError(cDt.getId(), "STRUCTURE", "component.minLength", "Component minLength is not defined.", position + "", "HIGH"));
      if((minLength != null && !minLength.equals("NA")) && !this.isInt(minLength)) vr.addDatatypeError(new DatatypeObjectError(cDt.getId(), "STRUCTURE", "component.minLength", "Component minLength is not integer.", position + "", "HIGH"));
      if((maxLength != null && !maxLength.equals("NA")) && !this.isIntOrStar(maxLength)) vr.addDatatypeError(new DatatypeObjectError(cDt.getId(), "STRUCTURE", "component.maxLength", "Component maxLength should be integer or *", position + "", "HIGH"));   
    }
