...
public class DatatypeServiceImpl implements DatatypeService {
  ...
  public DatatypeConformanceStatement convertDomainToConformanceStatement(Datatype datatype) {
    if (datatype != null) {
      ...
      if (datatype.getBinding() != null)
        result.setConformanceStatements(
            this.collectCS(datatype.getBinding().getConformanceStatementIds()));
      return result;
    }
    return null;
  }
        ...
        if (childDatatype.getComponents() != null && childDatatype.getComponents().size() > 0) {
          ...
          for (Component c : childDatatype.getComponents()) {
            ...
            if (childChildDt != null) {
              ...
              if (cSeb != null){
                cModel.addBinding(this.createBindingDisplay(cSeb, datatype.getId(), ViewScope.DATATYPE, 2, valueSetsMap));
                ...
                if (componentDatatype.getComponents() != null
                  ...
                  for (Component sc : componentDatatype.getComponents()) {
                    ...
                    if (childChildChildDt != null) {
                      ...
                      if (childCSeb != null){
                        scModel.addBinding(this.createBindingDisplay(childCSeb, datatype.getId(), ViewScope.DATATYPE, 2, valueSetsMap));
                      ...
                      if (scSeb != null){
                        scModel.addBinding(this.createBindingDisplay(scSeb, childChildDt.getId(), ViewScope.DATATYPE, 3, valueSetsMap));
        ...
        if (componentDatatype.getComponents() != null && componentDatatype.getComponents().size() > 0) {
          ...
          for (Component sc : componentDatatype.getComponents()) {
            ...
            if (childChildChildDt != null) {
              ...
              if (scSeb != null){
                scModel.addBinding(this.createBindingDisplay(scSeb, datatype.getId(), ViewScope.DATATYPE, 2, valueSetsMap));
                if (scSeb.getPredicateId() != null) {
                  Optional<Predicate> op = this.predicateRepository.findById(scSeb.getPredicateId());
                  if(op.isPresent() && op.get().getTrueUsage() != null && op.get().getFalseUsage() != null) {
                    scModel.setTrueUsage(op.get().getTrueUsage());
      ...
      if (dt.getComponents() != null && dt.getComponents().size() > 0) {
        for (Component c : dt.getComponents()) {
          ...
          if (childDt != null) {
            ...
            if (cSeb != null) {
              cModel.addBinding(this.createBindingDisplay(cSeb, datatype.getId(), ViewScope.DATATYPE, 1, valueSetsMap));
              if (cSeb.getPredicateId() != null) {
                Optional<Predicate> op = this.predicateRepository.findById(cSeb.getPredicateId());
                if(op.isPresent() && op.get().getTrueUsage() != null && op.get().getFalseUsage() != null) {
                  cModel.setTrueUsage(op.get().getTrueUsage());
              ...
              if (childDatatype.getComponents() != null
                ...
                for (Component sc : childDatatype.getComponents()) {
                  ...
                  if (childChildDt != null) {
                    ...
                    if (childSeb != null) {
                      scModel.addBinding(this.createBindingDisplay(childSeb, datatype.getId(), ViewScope.DATATYPE, 1, valueSetsMap));
                    ...
                    if (scSeb != null) {
                      scModel.addBinding(this.createBindingDisplay(scSeb, childDt.getId(), ViewScope.DATATYPE, 2, valueSetsMap));
                      if (scSeb.getPredicateId() != null) {
                        Optional<Predicate> op = this.predicateRepository.findById(scSeb.getPredicateId());
                        if(op.isPresent() && op.get().getTrueUsage() != null && op.get().getFalseUsage() != null) {
                          scModel.setTrueUsage(op.get().getTrueUsage());
   ...
   * 
   * @see
   * gov.nist.hit.hl7.igamt.datatype.service.DatatypeService#makeLocationInfo(gov.nist.hit.hl7.igamt
   ...
   */
  @Override
  public LocationInfo makeLocationInfoForComponent(ComplexDatatype dt,
      StructureElementBinding seb) {
   ...
   * @return
   */
  private LocationInfo makeLocationInfoForSubComponent(ComplexDatatype dt,
      StructureElementBinding seb) {
    if (dt != null && dt.getComponents() != null) {
      for (Component c : dt.getComponents()) {
        if (c.getId().equals(seb.getElementId())) {
  ...
  /* (non-Javadoc)
   * @see gov.nist.hit.hl7.igamt.datatype.service.DatatypeService#collectAvaliableConformanceStatements(java.lang.String, java.lang.String, java.lang.String)
   */
  @Override
  public Set<ConformanceStatement> collectAvaliableConformanceStatements(String documentId, String datatypeId, String datatypeName) {
    Set<ConformanceStatement> found = this.conformanceStatementRepository.findByIgDocumentIdAndStructureId(documentId, datatypeName);
    Set<ConformanceStatement> result = new HashSet<ConformanceStatement>();
    for(ConformanceStatement cs : found){
      if(!cs.getSourceIds().contains(datatypeId)) result.add(cs);
    }
    return result;
  }
}
