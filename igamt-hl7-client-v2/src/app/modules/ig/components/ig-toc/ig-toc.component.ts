...
export class IgTocComponent implements OnInit {
  ...
  @Output()
  nodeClick = new EventEmitter<TOCClickEvent>();
      ...
      actionMapping: {
        mouse: {
          ...
          click: (a, b) => {
            this.nodeClick.emit({
              element: b.data,
              editor: b.data.type === 'TEXT' ? EditorID.NARRATIVE : EditorID.METADATA,
            });
          },
        },
      },
