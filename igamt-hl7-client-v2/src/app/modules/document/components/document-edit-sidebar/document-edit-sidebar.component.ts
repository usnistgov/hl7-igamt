...
} from 'src/app/root-store/document/document-edit/ig-edit.index';
import {
...
import { selectIgId } from 'src/app/root-store/document/document-edit/ig-edit.index';
import * as fromIgDocumentEdit from 'src/app/root-store/document/document-edit/ig-edit.index';
import { ToggleDelta } from 'src/app/root-store/document/document-edit/ig-edit.index';
import * as config from '../../../../root-store/config/config.reducer';
import { CollapseTOC, CreateCoConstraintGroup, CreateCoConstraintGroupSuccess } from '../../../../root-store/document/document-edit/ig-edit.actions';
import * as fromIgEdit from '../../../../root-store/document/document-edit/ig-edit.index';
import { selectAllSegments } from '../../../../root-store/document/document-edit/ig-edit.selectors';
...
@Component({
  selector: 'app-document-edit-sidebar',
  templateUrl: './document-edit-sidebar.component.html',
  styleUrls: ['./document-edit-sidebar.component.scss'],
})
export class DocumentEditSidebarComponent implements OnInit {
  ...
  @Input()
  deltaMode = false;
  @ViewChild(DocumentTocComponent) toc: DocumentTocComponent;
