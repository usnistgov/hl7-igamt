...
import { ToggleFullScreen } from 'src/app/root-store/document/document-edit/ig-edit.index';
...
@Component({
  ...
  styleUrls: ['./document-edit-toolbar.component.scss'],
})
export class DocumentEditToolbarComponent implements OnInit, OnDestroy {
