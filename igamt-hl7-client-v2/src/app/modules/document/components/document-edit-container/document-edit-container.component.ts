...
import { ClearIgEdit, ExpandTOC } from '../../../../root-store/document/document-edit/ig-edit.actions';
import { AbstractEditorComponent } from '../../../core/components/abstract-editor-component/abstract-editor-component.component';
import { IWorkspaceActive } from '../../../shared/models/editor.class';
import { ITitleBarMetadata } from '../document-edit-titlebar/document-edit-titlebar.component';

@Component({
  selector: 'app-document-edit-container',
  templateUrl: './document-edit-container.component.html',
  styleUrls: ['./document-edit-container.component.scss'],
})
export class DocumentEditContainerComponent implements OnInit, AfterViewInit, OnDestroy {
