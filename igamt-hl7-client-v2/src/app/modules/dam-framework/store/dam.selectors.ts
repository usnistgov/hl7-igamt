...
import { IDamResource, IRepositoryStore } from '../models/state/repository';
import { IDamDataModel } from '../models/state/state';
import { IWorkspace, IWorkspaceActive } from '../models/state/workspace';

export const featureName = 'damf';
