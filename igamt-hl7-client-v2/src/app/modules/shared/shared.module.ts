...
import {
  ...
  FirstLetterPipe
} from "./components/active-users-list/active-users-list.component";
...
import { SlicingViewerDialogComponent } from "./components/slicing-viewer-dialog/slicing-viewer-dialog.component";
@NgModule({
  declarations: [
