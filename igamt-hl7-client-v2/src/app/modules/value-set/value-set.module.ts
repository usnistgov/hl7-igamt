...
import { ReasonForChangeDialogComponent } from './components/reason-for-change-dialog/reason-for-change-dialog.component';
...
@NgModule({
  declarations: [ValueSetCrossRefsComponent, ValueSetMetadataEditorComponent, ValueSetPredefEditorComponent, ValueSetPostdefEditorComponent, ValueSetStructureEditorComponent, DeltaEditorComponent, ReasonForChangeDialogComponent],
    imports: [
        CommonModule,
  ...
  entryComponents: [ReasonForChangeDialogComponent],
