...
import { IgDocument } from 'src/app/modules/document/models/ig/ig-document.class';
import {EditorSave, selectDelta, selectIgId} from 'src/app/root-store/document/document-edit/ig-edit.index';
import * as fromIgEdit from 'src/app/root-store/document/document-edit/ig-edit.index';
import { EditorChange, EditorSaveFailure, EditorSaveSuccess, IgEditActionTypes, UpdateActiveResource } from '../../../../root-store/document/document-edit/ig-edit.actions';
