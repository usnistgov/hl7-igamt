...
import { IgService } from 'src/app/modules/document/services/ig.service';
import { Message, MessageType, UserMessage } from '../../../modules/core/models/message/message.class';
import { IGDisplayInfo, IgDocument } from '../../../modules/document/models/ig/ig-document.class';
import { IAddResourceFromFile, ICopyResourceResponse, ICreateCoConstraintGroupResponse } from '../../../modules/document/models/toc/toc-operation.class';
