...
import { IgListItem } from 'src/app/modules/document/models/ig/ig-list-item.class';
import { ISortOptions } from 'src/app/modules/shared/models/sort.class';
import { DocumentListActions, IgListActionTypes, IgListLoad } from './document-list.actions';
...
export function reducer(state = initialState, action: DocumentListActions): IState {
  switch (action.type) {
