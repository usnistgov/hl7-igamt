...
import {IgListLoad} from 'src/app/root-store/document/document-list/document-list.actions';
import {IgListItem} from '../../../modules/document/models/ig/ig-list-item.class';
import {selectIgList} from '../document.reducer';
import {igListItemAdapter, IState} from './document-list.reducer';
