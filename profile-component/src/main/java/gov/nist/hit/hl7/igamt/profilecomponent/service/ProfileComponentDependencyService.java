 ...
 *
 */
public interface ProfileComponentDependencyService extends DependencyService<ProfileComponent, ProfileComponentDependencies> {


  void process(ProfileComponent pc,
