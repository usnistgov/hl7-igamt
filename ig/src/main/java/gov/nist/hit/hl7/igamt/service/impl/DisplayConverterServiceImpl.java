...
public class DisplayConverterServiceImpl implements DisplayConverterService{
  ...
  /* (non-Javadoc)
   * @see gov.nist.hit.hl7.igamt.ig.service.DisplayConverterService#convertTextSectionToNode(gov.nist.hit.hl7.igamt.shared.domain.TextSection)
   */
...
/* (non-Javadoc)
 * @see gov.nist.hit.hl7.igamt.ig.service.DisplayConverterService#ConvertModelToDomain(gov.nist.hit.hl7.igamt.ig.model.IGDisplay)
 */
@Override
