...
import gov.nist.hit.hl7.igamt.constraints.domain.assertion.SubContextAssertion;
...
public class XMLSerializeServiceImpl implements XMLSerializeService {
			...
			if (defaultHL7Version != null && dt.getDomainInfo() != null && dt.getDomainInfo().getVersion() != null) {
				if (defaultHL7Version.equals(dt.getDomainInfo().getVersion())) {
					...
					elmDatatype.addAttribute(new Attribute("Label",
							this.str(dt.getLabel() + "_" + dt.getDomainInfo().getVersion().replaceAll("\\.", "-"))));
				...
				if (complexDatatype.getComponents() != null) {
					...
					for (int i = 1; i < components.size() + 1; i++) {
						try {
							...
							if (defaultHL7Version != null && childDT.getDomainInfo() != null
	...
	public Element serializeValueSetXML(IgDataModel igModel) throws TableSerializationException {
		...
		elmTableLibrary.addAttribute(new Attribute("ValueSetLibraryIdentifier", igModel.getModel().getId()));
			...
			try {
				...
				if (t != null) {
					if (t.getCodes() == null || t.getCodes().size() == 0 || t.getCodes().size() > 500
						...
						if (defaultHL7Version != null && t.getDomainInfo() != null
								&& t.getDomainInfo().getVersion() != null
								&& !t.getBindingIdentifier().equals("HL70396")) {
	...
	private void serializeMain(Element e, IgDataModel igModel, String defaultHL7Version) {
		...
		for (DatatypeDataModel dtModel : igModel.getDatatypes()) {
			...
			if (defaultHL7Version != null && dtModel.getModel().getDomainInfo() != null
					&& dtModel.getModel().getDomainInfo().getVersion() != null) {
				if (defaultHL7Version.equals(dtModel.getModel().getDomainInfo().getVersion())) {
		...
		for (SegmentDataModel segModel : igModel.getSegments()) {
			...
			Element elm_ByID = new Element("ByID");
			if (defaultHL7Version != null && segModel.getModel().getDomainInfo() != null
	...
	private Element serializeDatatype(DatatypeDataModel dModel, IgDataModel igModel, String defaultHL7Version)
		...
		try {
			...
			if (defaultHL7Version != null && dModel.getModel().getDomainInfo() != null
					&& dModel.getModel().getDomainInfo().getVersion() != null) {
				if (defaultHL7Version.equals(dModel.getModel().getDomainInfo().getVersion())) {
					...
					elmDatatype.addAttribute(new Attribute("Label", this.str(dModel.getModel().getLabel() + "_"
			...
			if (dModel.getComponentDataModels() != null && dModel.getComponentDataModels().size() > 0) {
				...
				for (int i = 1; i < components.size() + 1; i++) {
					try {
						...
						elmComponent.addAttribute(new Attribute("Usage",
								this.str(this.changeCABtoC(c.getModel().getUsage()).toString())));

						if (defaultHL7Version != null && c.getDatatype().getDomainInfo() != null
								&& c.getDatatype().getDomainInfo().getVersion() != null) {
							if (defaultHL7Version.equals(c.getDatatype().getDomainInfo().getVersion())) {
								elmComponent
								...
								elmComponent.addAttribute(new Attribute("Datatype", this.str(c.getDatatype().getLabel()
										+ "_" + c.getDatatype().getDomainInfo().getVersion().replaceAll("\\.", "-"))));
							}
						} else {
							elmComponent.addAttribute(new Attribute("Datatype", this.str(c.getDatatype().getLabel())));
						}
						...
						if (c.getModel().getLengthType().equals(LengthType.Length)) {
							...
							if (c.getModel().getMinLength() != null && !c.getModel().getMinLength().isEmpty()) {
								elmComponent.addAttribute(
										new Attribute("MinLength", this.str(c.getModel().getMinLength())));
							...
							if (c.getModel().getMaxLength() != null && !c.getModel().getMaxLength().isEmpty()) {
								elmComponent.addAttribute(
										new Attribute("MaxLength", this.str(c.getModel().getMaxLength())));
							...
							for (ValuesetBindingDataModel binding : valueSetBindings) {
								try {
									...
									if (binding != null && binding.getBindingIdentifier() != null
										...
										if (defaultHL7Version != null && binding.getDomainInfo() != null
												&& binding.getDomainInfo().getVersion() != null) {
											if (defaultHL7Version.equals(binding.getDomainInfo().getVersion())
													|| binding.getBindingIdentifier().equals("HL70396")) {
	...
	private Element serializeSegment(SegmentDataModel sModel, IgDataModel igModel, Set<Datatype> missingDts,
		...
		try {
			...
			if (defaultHL7Version != null && sModel.getModel().getDomainInfo() != null
			...
			if (sModel.getModel().getName().equals("OBX") && sModel.getModel().getDynamicMappingInfo() != null
				...
				if (sModel.getModel().getDynamicMappingInfo() != null
					...
					for (DynamicMappingItem item : sModel.getModel().getDynamicMappingInfo().getItems()) {
						...
						if (itemDTModel != null) {
							if (defaultHL7Version != null && itemDTModel.getModel().getDomainInfo() != null
...
//        }
			...
			for (int i = 1; i < fields.size() + 1; i++) {
				try {
					...
					if (f != null) {
						...
						if (defaultHL7Version != null && dBindingModel.getDomainInfo() != null
								&& dBindingModel.getDomainInfo().getVersion() != null) {
							if (defaultHL7Version.equals(dBindingModel.getDomainInfo().getVersion())) {
								elmField.addAttribute(new Attribute("Datatype", this.str(dBindingModel.getLabel())));
							} else {
								elmField.addAttribute(new Attribute("Datatype", this.str(dBindingModel.getLabel() + "_"
										+ dBindingModel.getDomainInfo().getVersion().replaceAll("\\.", "-"))));
							}
						} else {
							elmField.addAttribute(new Attribute("Datatype", this.str(dBindingModel.getLabel())));
						}
	...
	private Element serializeSegmentRef(SegmentRefOrGroupDataModel segmentRefOrGroupDataModel, IgDataModel igModel,
		...
		try {
			...
			if (defaultHL7Version != null && segModel.getDomainInfo() != null
					&& segModel.getDomainInfo().getVersion() != null) {
				if (defaultHL7Version.equals(segModel.getDomainInfo().getVersion())) {
					...
					elmSegment.addAttribute(new Attribute("Ref", this.str(
							segModel.getLabel() + "_" + segModel.getDomainInfo().getVersion().replaceAll("\\.", "-"))));
				}
			} else {
				elmSegment.addAttribute(new Attribute("Ref", this.str(segModel.getLabel())));
			}
	...
	public void normalizeIgModel(IgDataModel igModel, String[] conformanceProfileIds)
		...
		for (DatatypeDataModel dtModel : igModel.getDatatypes()) {
			for (String key : dtModel.getValuesetMap().keySet()) {
				...
				if (pathList.size() > 1) {
					ComponentDataModel cModel = dtModel
							.findComponentDataModelByPosition(Integer.parseInt(pathList.remove(0)));
		...
		for (ConformanceProfileDataModel cpModel : igModel.getConformanceProfiles()) {
			for (String key : cpModel.getValuesetMap().keySet()) {
				List<String> pathList = new LinkedList<String>(Arrays.asList(key.split("\\.")));
				SegmentRefOrGroupDataModel childModel = cpModel
						.findChildByPosition(Integer.parseInt(pathList.remove(0)));
				updateGroupOrSegmentRefModel(pathList, childModel, igModel, cpModel.getValuesetMap().get(key),
	...
	private String generateAssertionScript(Assertion assertion, Level level, String targetId, InstancePath context,
			boolean presenceCheckOn) {
		if (assertion instanceof NotAssertion) {
			return "<NOT>" + this.generateAssertionScript(((NotAssertion) assertion).getChild(), level, targetId,
					context, presenceCheckOn) + "</NOT>";
		} else if (assertion instanceof IfThenAssertion) {
			return "<IMPLY>"
					+ this.generateAssertionScript(((IfThenAssertion) assertion).getIfAssertion(), level, targetId,
							context, true)
					+ this.generateAssertionScript(((IfThenAssertion) assertion).getThenAssertion(), level, targetId,
							context, true)
					+ "</IMPLY>";
			...
			return this.generateSubContextScript((SubContextAssertion) assertion, level, targetId, context,
					presenceCheckOn);
		} else if (assertion instanceof SingleAssertion) {
			return this.generateSingleAssertionScript((SingleAssertion) assertion, level, targetId, context,
					presenceCheckOn);
		}
	...
	private String generateSubContextScript(SubContextAssertion subContextAssertion, Level level, String targetId,
			InstancePath context, boolean presenceCheckOn) {
		String script = "";

		if (subContextAssertion.getContext() != null && subContextAssertion.getContext().getPath() != null
				&& subContextAssertion.getContext().getOccurenceType() != null) {
			String sPathStr = this.generatePath(subContextAssertion.getContext().getPath(), targetId, level, context);
			String notPresentBehaviorStr;
			if (presenceCheckOn)
				notPresentBehaviorStr = "FAIL";
			else
				notPresentBehaviorStr = "PASS";

			if (subContextAssertion.getContext().getOccurenceType() != null) {
				if (subContextAssertion.getContext().getOccurenceType().equals("atLeast")) {
				} else if (subContextAssertion.getContext().getOccurenceType().equals("instance")) {
					sPathStr = this.replaceLast(sPathStr, "[*]",
							"" + subContextAssertion.getContext().getOccurenceValue());
				} else if (subContextAssertion.getContext().getOccurenceType().equals("noOccurrence")) {
				}
			}
			...
			if (subContextAssertion.getContext().getOccurenceType().equals("atLeast")) {
				script = "<SubContext " 
						...
						+ ">" 
						+ this.generateAssertionScript(subContextAssertion.getChild(), level, targetId, context, presenceCheckOn) 
						+ "</SubContext>";
			} else if (subContextAssertion.getContext().getOccurenceType().equals("exactlyOne")) {
				script = "<SubContext " 
						+ "Path=\"" + sPathStr + "\" " 
						+ "MinOccurrence=\"1\" "
						+ "MaxOccurrence=\"1\" "
						...
						+ this.generateAssertionScript(subContextAssertion.getChild(), level, targetId, context, presenceCheckOn) 
						+ "</SubContext>";
			} else if (subContextAssertion.getContext().getOccurenceType().equals("all")) {
				script = "<SubContext " 
						+ "Path=\"" + sPathStr + "\" " 
						+ "AtLeastOnce=\"false\" "
						+ "NotPresentBehavior=\""+ notPresentBehaviorStr + "\" "
						...
						+ this.generateAssertionScript(subContextAssertion.getChild(), level, targetId, context, presenceCheckOn) 
						+ "</SubContext>";
			} else if (subContextAssertion.getContext().getOccurenceType().equals("count")) {
				script = "<SubContext " 
						+ "Path=\"" + sPathStr + "\" " 
						+ "MinOccurrence=\"" + subContextAssertion.getContext().getOccurenceValue() + "\" "
						+ "MaxOccurrence=\"" + subContextAssertion.getContext().getOccurenceValue() + "\" "
						+ "NotPresentBehavior=\""+ notPresentBehaviorStr + "\" "
						+ ">" 
						+ this.generateAssertionScript(subContextAssertion.getChild(), level, targetId, context, presenceCheckOn) 
						+ "</SubContext>";
			} else if (subContextAssertion.getContext().getOccurenceType().equals("noOccurrence")) {
				script = "<NOT><SubContext " 
						+ "Path=\"" + sPathStr + "\" " 
						+ "MinOccurrence=\"1\" "
						+ "MaxOccurrence=\"*\" "
						+ "NotPresentBehavior=\""+ notPresentBehaviorStr + "\" "
	 ...
	 * @return
	 */
	private String generateSingleAssertionScript(SingleAssertion assertion, Level level, String targetId,
			InstancePath context, boolean presenceCheckOn) {
		...
		case notValued:
			...
			break;
		case containValue:
			result = "<PlainText Path=\"" + sPathStr + "\" Text=\"" + complement.getEscapeXml() + "\" IgnoreCase=\""
					+ complement.isIgnoreCase() + "\" AtLeastOnce=\"" + atLeastOnce + "\" NotPresentBehavior=\""
					+ notPresentBehaviorStr + "\"/>";
			break;
		case notContainValue:
			result = "<NOT><PlainText Path=\"" + sPathStr + "\" Text=\"" + complement.getEscapeXml()
					...
					+ "\" NotPresentBehavior=\"" + notPresentBehaviorStr + "\"/></NOT>";
			break;
		...
		case containListValues:
			result = "<StringList Path=\"" + sPathStr + "\" CSV=\"" + String.join(",", complement.getValues())
					+ "\" IgnoreCase=\"" + complement.isIgnoreCase() + "\" AtLeastOnce=\"" + atLeastOnce
					+ "\" NotPresentBehavior=\"" + notPresentBehaviorStr + "\"/>";
			break;
		case notContainListValues:
			result = "<NOT><StringList Path=\"" + sPathStr + "\" CSV=\"" + String.join(",", complement.getValues())
					+ "\" IgnoreCase=\"" + complement.isIgnoreCase() + "\" AtLeastOnce=\"" + atLeastOnce
					+ "\" NotPresentBehavior=\"" + notPresentBehaviorStr + "\"/></NOT>";
			break;
		...
		case containCode:
			result = "<PlainText Path=\"" + sPathStr + "\" Text=\"" + complement.getEscapeXml() + "\" IgnoreCase=\""
					+ false + "\" AtLeastOnce=\"" + atLeastOnce + "\" NotPresentBehavior=\"" + notPresentBehaviorStr
					+ "\"/>";
			break;
		case containCodeDesc:
			result = "<PlainText Path=\"" + sPathStr + "\" Text=\"" + complement.getValue() + "\" IgnoreCase=\"" + false
					+ "\" AtLeastOnce=\"" + atLeastOnce + "\" NotPresentBehavior=\"" + notPresentBehaviorStr + "\"/>";
			break;
		case containListCodes:
			result = "<StringList Path=\"" + sPathStr + "\" CSV=\"" + String.join(",", complement.getValues())
					+ "\" IgnoreCase=\"" + false + "\" AtLeastOnce=\"" + atLeastOnce + "\" NotPresentBehavior=\""
					+ notPresentBehaviorStr + "\"/>";
			break;
		...
		case containListCodesDesc:
			...
			break;
		case regex:
			result = "<Format Path=\"" + sPathStr + "\" Regex=\"" + complement.getValue() + "\" AtLeastOnce=\""
					+ atLeastOnce + "\" NotPresentBehavior=\"" + notPresentBehaviorStr + "\"/>";
			break;
		case positiveInteger:
			result = "<Format Path=\"" + sPathStr + "\" Regex=\"" + "^[1-9]\\d*$" + "\" AtLeastOnce=\"" + atLeastOnce
					+ "\" NotPresentBehavior=\"" + notPresentBehaviorStr + "\"/>";
			break;
		case LOINC:
			result = "<StringFormat Path=\"" + sPathStr + "\" Format=\"" + "LOINC" + "\" AtLeastOnce=\"" + atLeastOnce
					+ "\" NotPresentBehavior=\"" + notPresentBehaviorStr + "\"/>";
			break;
		case SNOMED:
			result = "<StringFormat Path=\"" + sPathStr + "\" Format=\"" + "SNOMED" + "\" AtLeastOnce=\"" + atLeastOnce
					+ "\" NotPresentBehavior=\"" + notPresentBehaviorStr + "\"/>";
			break;
		case sequentially:
			...
			break;
		case iso:
			result = "<Format Path=\"" + sPathStr + "\" Regex=\"" + "[0-2](\\.(0|[1-9][0-9]*))*" + "\" AtLeastOnce=\""
					+ atLeastOnce + "\" NotPresentBehavior=\"" + notPresentBehaviorStr + "\"/>";
			break;
		case cEarlier:
			result = "<PathValue Path1=\"" + sPathStr + "\" Operator=\"" + "LT" + "\" Path2=\"" + cPathStr
					+ "\" NotPresentBehavior=\"" + notPresentBehaviorStr + "\"/>";
			break;
		case cEarlierEquivalent:
			result = "<PathValue Path1=\"" + sPathStr + "\" Operator=\"" + "LE" + "\" Path2=\"" + cPathStr
					+ "\" NotPresentBehavior=\"" + notPresentBehaviorStr + "\"/>";
			break;
		case cEquivalent:
			result = "<PathValue Path1=\"" + sPathStr + "\" Operator=\"" + "EQ" + "\" Path2=\"" + cPathStr
					+ "\" NotPresentBehavior=\"" + notPresentBehaviorStr + "\"/>";
			break;
		case cEquivalentLater:
			result = "<PathValue Path1=\"" + sPathStr + "\" Operator=\"" + "GE" + "\" Path2=\"" + cPathStr
					+ "\" NotPresentBehavior=\"" + notPresentBehaviorStr + "\"/>";
			break;
		case cIdentical:
			result = "<PathValue Path1=\"" + sPathStr + "\" Operator=\"" + "EQ" + "\" Path2=\"" + cPathStr
			...
			break;
		case cLater:
			result = "<PathValue Path1=\"" + sPathStr + "\" Operator=\"" + "GT" + "\" Path2=\"" + cPathStr
					+ "\" NotPresentBehavior=\"" + notPresentBehaviorStr + "\"/>";
			break;
	 ...
	 * @param result
	 */
	private void visitSegOrGroup(Set<SegmentRefOrGroup> segOrGroups, InstancePath child, List<String> result) {
