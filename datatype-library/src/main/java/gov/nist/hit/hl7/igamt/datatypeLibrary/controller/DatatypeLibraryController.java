...
@RestController
public class DatatypeLibraryController extends BaseController {
  ...
  public DatatypeLibraryController() {
	super();
}
...
/**
   ...
   */
  @RequestMapping(value = "/api/datatypelibraries/{id}/export/html", method = RequestMethod.GET)
   ...
   * @throws ExportException
   */
  @RequestMapping(value = "/api/datatypelibraries/{id}/export/word", method = RequestMethod.GET)
  public @ResponseBody void exportIgDocumentToWord(@PathVariable("id") String id,
    ...
    if (authentication != null) {
      String username = authentication.getPrincipal().toString();
      ExportedFile exportedFile = datatypeLibraryExportService.exportDatatypeLibraryToWord(username, id);
