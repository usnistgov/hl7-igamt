...
public class EvolutionComparatorImpl implements EvolutionComparatorService {
	...
	@Override
	public boolean compareDatatypes(Datatype d1, Datatype d2, HashMap<EvolutionPropertie, Boolean> criterias)
	...
	@Override
	public boolean compareComponent(Component c1, Component c2, HashMap<EvolutionPropertie, Boolean> criterias)
			throws DatatypeNotFoundException {

		if (criterias.containsKey(EvolutionPropertie.CPNAME) && criterias.get((EvolutionPropertie.CPNAME))) {
		...
		if (criterias.containsKey(EvolutionPropertie.CPUSAGE) && criterias.get((EvolutionPropertie.CPUSAGE))) {
		...
		if (criterias.containsKey(EvolutionPropertie.CONFLENGTH) && criterias.get((EvolutionPropertie.CONFLENGTH))) {
		...
		if (criterias.containsKey(EvolutionPropertie.MINLENGTH) && criterias.get((EvolutionPropertie.MINLENGTH))) {
		...
		if (criterias.containsKey(EvolutionPropertie.MAXLENGTH) && criterias.get((EvolutionPropertie.MAXLENGTH))) {
		...
		if (criterias.containsKey(EvolutionPropertie.CPDATATYPE) && criterias.get((EvolutionPropertie.CPDATATYPE))) {
			Datatype d1 = null;
			Datatype d2 = null;
	 ...
	 * 
	 * @see
	 * gov.nist.hit.hl7.igamt.datatypeLibrary.service.DeltaService#getDatatypesDelta
	 * (gov.nist.hit.hl7. igamt.datatype.domain.Datatype,
	 * gov.nist.hit.hl7.igamt.datatype.domain.Datatype, java.util.HashMap)
	 */
	@Override
	public DeltaTreeNode getDatatypesDelta(Datatype d1, Datatype d2, HashMap<EvolutionPropertie, Boolean> criterias)
			throws DatatypeNotFoundException {
	...
	private void compareComplexDatatypes(ComplexDatatype d1, ComplexDatatype d2,
			HashMap<EvolutionPropertie, Boolean> criterias, DeltaTreeNode deltaNode) throws DatatypeNotFoundException {
	 ...
	 * @throws DatatypeNotFoundException
	 */
	private void addNewComponent(Component c1, HashMap<EvolutionPropertie, Boolean> criterias, DeltaTreeNode deltaNode,
			String location) throws DatatypeNotFoundException {
	 ...
	 * @throws DatatypeNotFoundException
	 */
	private void compareComponent(Component c1, Component c2, HashMap<EvolutionPropertie, Boolean> criterias,
		...
		if (criterias.containsKey(EvolutionPropertie.CPUSAGE) && criterias.get((EvolutionPropertie.CPUSAGE))) {
			if (!c1.getUsage().equals(c2.getUsage())) {
				childData.addCell(EvolutionPropertie.CPUSAGE,
						new DeltaCell(c1.getUsage().toString(), c2.getUsage().toString()));
			}
		...
		if (criterias.containsKey(EvolutionPropertie.CONFLENGTH) && criterias.get((EvolutionPropertie.CONFLENGTH))) {
			if (!c1.getConfLength().equalsIgnoreCase(c2.getConfLength())) {
				childData.addCell(EvolutionPropertie.CONFLENGTH, new DeltaCell(c1.getConfLength(), c2.getConfLength()));
			}
		...
		if (criterias.containsKey(EvolutionPropertie.MINLENGTH) && criterias.get((EvolutionPropertie.MINLENGTH))) {
			if (!c1.getMinLength().equalsIgnoreCase(c2.getMinLength())) {
				childData.addCell(EvolutionPropertie.MINLENGTH, new DeltaCell(c1.getMinLength(), c2.getMinLength()));
			}
		...
		if (criterias.containsKey(EvolutionPropertie.MAXLENGTH) && criterias.get((EvolutionPropertie.MAXLENGTH))) {
			if (!c1.getMaxLength().equalsIgnoreCase(c2.getMaxLength())) {
				childData.addCell(EvolutionPropertie.MAXLENGTH, new DeltaCell(c1.getMaxLength(), c2.getMaxLength()));
			}
