...
public class PageCreator {
	...
	public void generateIndex(WebExportObject webExportObject) {
		BasicXsl bx = new BasicXsl();
		WritePage("/Users/ynb4/ExportV2/XmlFiles/AllDatatypes.xml", webExportObject.getAllDatatypesXml());
...
//		bx.xsl("/Users/ynb4/ExportV2/XmlFiles/AllDatatypes.xml", "/Users/ynb4/ExportV2/Pages/IndexTableDatatypes.html" , "/Users/ynb4/ExportV2/Pages/AllDatatypesInTableIndex.xsl");
		String resultPage = createPage("/Users/ynb4/ExportV2/ForJava/indexCopy.html", "<ReplaceVersionLayer></ReplaceVersionLayer>", hw.generateVersionInIndex(webExportObject));
...
//		System.out.println(resultPage2);
	...
	public void generateLeafPageTable(WebExportObject webExportObject) {
		// Remove root datatype from both lists
		
		
		
		BasicXsl bx = new BasicXsl();		
		for(Datatype datatype : webExportObject.getMapDatatypeToXML().keySet()) {
			if(!datatype.getExt().isEmpty()) {
				WritePage("/Users/ynb4/ExportV2/XmlFiles/XmlDatatype_"+datatype.getName()+datatype.getExt()+".xml", webExportObject.getMapDatatypeToXML().get(datatype));
			...
			for(String version : webExportObject.getDatatypesbyVersionThenName().keySet()) {
				for(String name : webExportObject.getDatatypesbyVersionThenName().get(version).keySet()) {
					String allLeafTableResult = "";
					
					for(int i=0 ; i<= webExportObject.getDatatypesbyVersionThenName().get(version).get(name).size() -1 ; i+=2) {
						String firstDatatype ="";

							bx.xsl("/Users/ynb4/ExportV2/XmlFiles/XmlDatatype_"+webExportObject.getDatatypesbyVersionThenName().get(version).get(name).get(i).getName()+webExportObject.getDatatypesbyVersionThenName().get(version).get(name).get(i).getExt()+".xml", "/Users/ynb4/ExportV2/Pages/DatatypeTemp1.html" , "/Users/ynb4/ExportV2/Xslt/TransformToMultipleTable.xsl");
							firstDatatype =  readFromFileToString("/Users/ynb4/ExportV2/Pages/DatatypeTemp1.html");
							String secondDatatype ="";
							if(i+1<webExportObject.getDatatypesbyVersionThenName().get(version).get(name).size()) {
							bx.xsl("/Users/ynb4/ExportV2/XmlFiles/XmlDatatype_"+webExportObject.getDatatypesbyVersionThenName().get(version).get(name).get(i+1).getName()+webExportObject.getDatatypesbyVersionThenName().get(version).get(name).get(i+1).getExt()+".xml", "/Users/ynb4/ExportV2/Pages/DatatypeTemp2.html" , "/Users/ynb4/ExportV2/Xslt/TransformToMultipleTable.xsl");
...
//					System.out.println("here"+pageToWrite);
			...
			for(String name : webExportObject.getDatatypesbyNameThenVersion().keySet()) {
				for(Set<String> versionSet : webExportObject.getDatatypesbyNameThenVersion().get(name).keySet()) {
					String allLeafTableResult = "";
					String secondDatatypeLeaf ="";
					String firstDatatypeLeaf ="";
					for(int i=0 ; i<= webExportObject.getDatatypesbyNameThenVersion().get(name).get(versionSet).size() -1 ; i+=2) {
						String firstDatatype ="";

							bx.xsl("/Users/ynb4/ExportV2/XmlFiles/XmlDatatype_"+webExportObject.getDatatypesbyNameThenVersion().get(name).get(versionSet).get(i).getName()+webExportObject.getDatatypesbyNameThenVersion().get(name).get(versionSet).get(i).getExt()+".xml", "/Users/ynb4/ExportV2/Pages/DatatypeTemp1.html" , "/Users/ynb4/ExportV2/Xslt/TransformToMultipleTable.xsl");
							firstDatatype =  readFromFileToString("/Users/ynb4/ExportV2/Pages/DatatypeTemp1.html");
							String secondDatatype ="";
							if(i+1<webExportObject.getDatatypesbyNameThenVersion().get(name).get(versionSet).size()) {
							bx.xsl("/Users/ynb4/ExportV2/XmlFiles/XmlDatatype_"+webExportObject.getDatatypesbyNameThenVersion().get(name).get(versionSet).get(i+1).getName()+webExportObject.getDatatypesbyNameThenVersion().get(name).get(versionSet).get(i+1).getExt()+".xml", "/Users/ynb4/ExportV2/Pages/DatatypeTemp2.html" , "/Users/ynb4/ExportV2/Xslt/TransformToMultipleTable.xsl");
							secondDatatype =  readFromFileToString("/Users/ynb4/ExportV2/Pages/DatatypeTemp2.html");
							}
