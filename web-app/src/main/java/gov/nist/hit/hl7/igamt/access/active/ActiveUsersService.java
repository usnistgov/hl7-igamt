...
public class ActiveUsersService {
    ...
    public ActiveUser getActiveUserForIg(String session, String igId, UsernamePasswordAuthenticationToken token) throws Exception {
        Set<AccessLevel> permissions = this.accessControlService.getDocumentAccessPermission(Type.IGDOCUMENT, igId, new AccessToken(token.getName(), new HashSet<>(token.getAuthorities())));
