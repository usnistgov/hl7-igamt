...
public enum PropertyType {
  ...
  STRUCTSEGMENT,
  FIELD,
  USAGE, LENGTH, CARDINALITY, TRUEUSAGE, FALSEUSAGE, CARDINALITYMIN, CARDINALITYMAX, LENGTHMIN, LENGTHMAX, CONFLENGTH, LENGTHTYPE, DATATYPE, VALUESET, SINGLECODE, CONSTANTVALUE, PREDICATE, DEFINITIONTEXT, COMMENT, SEGMENTREF, DTMSTRUC, SHORTDESCRIPTION, VALUE, 
  ...
  SLICING,
  SLICE_FLAVOR,
  ORDERED_SLICE_POSITION,
  CONDITIONAL_SLICE_ASSERTION
