			...
			if (datatypeRegistry != null) {
				if (!datatypeRegistry.getChildren().isEmpty()) {
					for (Link datatypeLink : datatypeRegistry.getChildren()) {
							if((exportFilterDecision == null) || (exportFilterDecision != null && exportFilterDecision.getDatatypesFilterMap().keySet().contains(datatypeLink.getId()) && exportFilterDecision.getValueSetFilterMap().get(datatypeLink.getId()) == true)) {
			...
			if (valuesetRegistry != null) {
				if (!valuesetRegistry.getChildren().isEmpty()) {
					for (Link valuesetLink : valuesetRegistry.getChildren()) {
						if((exportFilterDecision == null) || (exportFilterDecision != null && exportFilterDecision.getValueSetFilterMap().keySet().contains(valuesetLink.getId()) && exportFilterDecision.getValueSetFilterMap().get(valuesetLink.getId()) == true)) {
			...
			if (conformanceProfileRegistry != null) {
				if (!conformanceProfileRegistry.getChildren().isEmpty()) {
					for (Link conformanceProfileLink : conformanceProfileRegistry.getChildren()) {
						if((exportFilterDecision == null) || (exportFilterDecision != null && exportFilterDecision.getConformanceProfileFilterMap().keySet().contains(conformanceProfileLink.getId()) && exportFilterDecision.getConformanceProfileFilterMap().get(conformanceProfileLink.getId()) == true)) {
			...
			if (segmentRegistry != null) {
				if (segmentRegistry.getChildren() != null && !segmentRegistry.getChildren().isEmpty()) {
					for (Link segmentLink : segmentRegistry.getChildren()) {
						if((exportFilterDecision == null) || (exportFilterDecision != null && exportFilterDecision.getSegmentFilterMap().keySet().contains(segmentLink.getId()) && exportFilterDecision.getSegmentFilterMap().get(segmentLink.getId()) == true)) {
