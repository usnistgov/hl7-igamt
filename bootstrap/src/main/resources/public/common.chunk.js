...
var SegmentEditStructureComponent = (function () {
    function SegmentEditStructureComponent(indexedDbService, route, router, configService, segmentsService, datatypesService, constraintsService, datatypesTocService, valuesetsTocService) {
        var _this = this;
        this.indexedDbService = indexedDbService;
        this.route = route;
        this.router = router;
