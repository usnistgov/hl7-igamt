 ...
 */
@ControllerAdvice
public class ValuesetExceptionHandler {
 
  @ResponseBody
  @ResponseStatus(HttpStatus.BAD_REQUEST)
  @ExceptionHandler({ValuesetException.class})
  public ResponseMessage handleSegmentException(ValuesetException exception) {
