...
export class LibraryListComponent implements OnInit {
  ...
  constructor(public activeRoute: ActivatedRoute,public  router:Router,private confirmationService: ConfirmationService, private http:HttpClient ) {
    this.activeRoute.data.map(data =>data.libList).subscribe(x=>{
      this.libs=x;
      this.sortOptions = [
