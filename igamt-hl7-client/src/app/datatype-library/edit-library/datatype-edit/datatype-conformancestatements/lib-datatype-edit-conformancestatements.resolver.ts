...
@Injectable()
export  class LibDatatypeEditConformanceStatementsResolver implements Resolve<any>{
    ...
    resolve(route: ActivatedRouteSnapshot, rstate : RouterStateSnapshot): Promise<any>{
        ...
        return this.datatypeService.getDatatypeConformanceStatements(datatypeId);
    }
}
